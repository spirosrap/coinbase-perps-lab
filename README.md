...
- a compact top-of-page current-positions strip so all live positions stay visible without scrolling to the full cards
- a compact top-of-page entry shortlist for the top ranked stock-perp candidates, with sequential allocation on remaining deployable margin
